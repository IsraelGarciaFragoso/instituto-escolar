...
if (!isset($_SESSION["IDUsuario"])) //condicional que valida si el usuario inicio la sesion 
{
...
function notificaToast($mensaje) //metodo que permitira mostrar las notificaciones
{
    ...
    echo "<a href='inscribirES.html'>Regresar al formulario</a>";//permite redireccionar despues de mostrar el mensaje
    exit;
}
