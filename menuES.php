...
if (!isset($_SESSION["IDUsuario"]) || $_SESSION["TipoUsuario"] !== "es") 
{
    header("Location: menuES.php");//si la condicion es correcta redirecciona a la pagian del menuce
    exit;
}
...
<title>Menu Estudiante</title><!--se establece el titulo de la pagina-->
...
<a class ="navbar-brand" href="#">Bienvenido ES</a><!--esta clase permite establecer un logo o nombre de marca-->
